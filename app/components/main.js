		...
		return(
			...
			<div className="container">
				...
				<div className="row">
					...
					<div className="jumbotron" style={{'backgroundImage': 'url(./../images/newspaper.jpg)', 'backgroundRepeat': 'no-repeat', 'backgroundPosition': 'center', 'backgroundSize': '100% 100%', 'backgroundAttachment': 'fixed'}}>
